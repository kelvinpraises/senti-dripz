export const swapErc20 = [
  {
    type: "impl",
    name: "SwapERC20Impl",
    interface_name: "starklens_contracts::lens_swap_erc20::ISwapERC20",
  },
  {
    type: "struct",
  ...
  {
    type: "enum",
    name: "core::option::Option::<(core::starknet::contract_address::ContractAddress, core::integer::u256)>",
    variants: [
      {
        name: "Some",
  ...
  {
    type: "struct",
    name: "starklens_contracts::lens_swap_erc20::GatingCriteria",
    members: [
      {
        name: "gated_account",
        type: "core::starknet::contract_address::ContractAddress",
      ...
      {
        name: "min_balance",
        type: "core::option::Option::<(core::starknet::contract_address::ContractAddress, core::integer::u256)>",
      },
      {
        name: "token_id",
        type: "core::option::Option::<(core::starknet::contract_address::ContractAddress, core::integer::u256)>",
  ...
  {
    type: "struct",
    name: "starklens_contracts::lens_swap_erc20::Instance",
    members: [
      { name: "id", type: "core::integer::u32" },
      {
        name: "initiator",
        type: "core::starknet::contract_address::ContractAddress",
      },
      {
        name: "initiator_erc20",
        type: "core::starknet::contract_address::ContractAddress",
      },
      { name: "initiator_amount", type: "core::integer::u256" },
      {
        name: "counter_party_erc20",
        type: "core::starknet::contract_address::ContractAddress",
      },
      { name: "counter_party_amount", type: "core::integer::u256" },
      { name: "state", type: "core::integer::u8" },
      {
        name: "gating",
        type: "starklens_contracts::lens_swap_erc20::GatingCriteria",
      },
    ],
  },
  {
    type: "interface",
    name: "starklens_contracts::lens_swap_erc20::ISwapERC20",
    items: [
      {
        type: "function",
        name: "begin",
      ...
      },
      {
        ...
        name: "find_instance",
        inputs: [{ name: "id", type: "core::integer::u32" }],
        outputs: [{ type: "starklens_contracts::lens_swap_erc20::Instance" }],
  ...
  {
    type: "event",
    name: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Begun",
    kind: "struct",
    members: [
      { name: "id", type: "core::integer::u32", kind: "key" },
      {
        name: "initiator",
        type: "core::starknet::contract_address::ContractAddress",
        kind: "data",
  ...
  {
    type: "event",
    name: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Cancelled",
    kind: "struct",
    members: [{ name: "id", type: "core::integer::u32", kind: "key" }],
  },
  {
    type: "event",
    name: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Finished",
    kind: "struct",
    members: [{ name: "id", type: "core::integer::u32", kind: "key" }],
  },
  {
    type: "event",
    name: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Event",
    kind: "enum",
    variants: [
      {
        name: "Begun",
        type: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Begun",
        kind: "nested",
      },
      {
        name: "Cancelled",
        type: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Cancelled",
        kind: "nested",
      },
      {
        name: "Finished",
        type: "starklens_contracts::lens_swap_erc20::LenSwapERC20::Finished",
        kind: "nested",
      },
    ],
  },
